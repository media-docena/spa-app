...
function CardAbout({ name, position, image, github }) {
  return (
    <>
      <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border border-gray-200 cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600">
        <img
